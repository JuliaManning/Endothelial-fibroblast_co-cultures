...
# select only mono-cultured fibrblasts 
...
save(fibrocountdata, fibrosampleinfo, modelMatrix, vst_pcDat, vstcounts, design, dds,
     file="~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Outputs/Fibroblasts/Fibroblasts_sex_genes_removed_dds_mono-culture.RData")

# plot the dispersion estimates
tiff(filename = "~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Fibroblast only/MonoFinal/Dispersion_plot.tiff",
...
# Diagnosis
tiff(filename = "~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Fibroblast only/MonoFinal/Mono-cultured fibroblasts PCA coloured by diagnosis no sex biplot.tiff",
...
tiff(filename = "~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Fibroblast only/MonoFinal/Mono-cultured fibroblasts pairsplot coloured by diagnosis no sex biplot.tiff",
     width = 1000, height = 500)
PCAtools::pairsplot(p, colby = 'Diagnosis', pointSize=3)
dev.off()

# Joint 
tiff(filename = "~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Fibroblast only/MonoFinal/Mono-cultured fibroblasts PCA coloured by Joint no sex biplot.tiff",
     width = 750, height = 500)
...
tiff(filename = "~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Fibroblast only/MonoFinal/Mono-cultured fibroblasts pairsplot coloured by Joint no sex biplot.tiff",
     width = 1000, height = 500)
PCAtools::pairsplot(p, colby = 'Joint', pointSize=3)
dev.off()

# Fibroblast sex
tiff(filename = "~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Fibroblast only/MonoFinal/Mono-cultured fibroblasts PCA coloured by Fibroblast sex no sex biplot.tiff",
     width = 750, height = 500)
...
tiff(filename = "~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Fibroblast only/MonoFinal/Mono-cultured fibroblasts pairsplot coloured by Fiborblast_Sex no sex pairsplot.tiff",
     width = 1000, height = 500)
PCAtools::pairsplot(p, colby = 'Fibroblast_Sex', pointSize=3)
dev.off()

# EC sex
tiff(filename = "~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Fibroblast only/MonoFinal/Mono-cultured fibroblasts PCA coloured by EC sex no sex biplot.tiff",
     width = 750, height = 500)
...
tiff(filename = "~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Fibroblast only/MonoFinal/Mono-cultured fibroblasts pairsplot coloured by EC_Sex no sex pairsplot.tiff",
     width = 1000, height = 500)
...
tiff(filename = "~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Fibroblast only/MonoFinal/Mono-cultured Fibroblasts PCA coloured by different factors no sex.tiff",
...
# Loadings plot
tiff(filename = "~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Fibroblast only/MonoFinal/Fibroblasts PCA loadings plot no sex.tiff",
...
tiff(filename = "~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Fibroblast only/MonoFinal/Mono-cultured Fibroblasts 100 variable genes heatmap no sex.tiff",
...
save(dds, fibrocountdata, fibrosampleinfo, modelMatrix, vst_pcDat, vstcounts, design,  
     file="~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Outputs/Fibroblasts/Fibroblasts_sex_removed_monoculture.RData")

# Pick up here for your write up!

load(file="~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Outputs/Fibroblasts/Fibroblasts_sex_removed_monoculture.RData")
...
write.csv(as.data.frame(annotJRep_vs_Res), 
          file="~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Outputs/Fibroblasts/Fibro_mono_JRep_vs_Res_all.csv")
...
write.csv(as.data.frame(JRep_vs_Res_sig), 
          file="~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Outputs/Fibroblasts/Fibro_mono_JRep_vs_Res_sig.csv")
...
write.csv(as.data.frame(annotVeRA_vs_Res), 
          file="~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Outputs/Fibroblasts/Fibro_mono_VeRA_vs_Res_all.csv")
...
write.csv(as.data.frame(VeRA_vs_Res_sig), 
          file="~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Outputs/Fibroblasts/Fibro_mono_VeRA_vs_Res_sig.csv")
...
write.csv(as.data.frame(annotVeRA_vs_JRep), 
          file="~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Outputs/Fibroblasts/Fibro_mono_VeRA_vs_JRep_all.csv")
# export the significant results
...
write.csv(as.data.frame(VeRA_vs_JRep_sig), 
          file="~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Outputs/Fibroblasts/Fibro_mono_VeRA_vs_JRep_sig.csv")
...
tiff(filename = "~/OneDrive/Documents/PhD/Projects/Endothelial RNA seq/Fibroblast only/MonoFinal/Fibroblast mono volcanos.tiff",
...
EnhancedVolcano(JRep_vs_Res_shrunk,
                lab = rownames(JRep_vs_Res_shrunk),
                xlim = c(-4, 4),
                ylim = c(0, 7),
                x = 'log2FoldChange',
...
plotCounts(dds, gene = "ENSG00000105664", intgroup = "Diagnosis")

COMP <- plotCounts(dds, gene = "ENSG00000105664", intgroup = "Diagnosis", returnData = TRUE)

ggplot(COMP, aes(x=Diagnosis, y= count)) + 
...
kk_Jrep_vs_Res <- enrichKEGG(gene = sigGenesJRep_vs_Res, organism = 'hsa')
