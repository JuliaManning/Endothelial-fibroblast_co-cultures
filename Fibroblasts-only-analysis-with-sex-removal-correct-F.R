...
ggplot(a, aes(x=Diagnosis, y=count, colour = macrosampleinfo$Batch, label = macrosampleinfo$SampleName)) + 
  geom_point(position=position_jitter(w=0.1,h=0)) + 
  scale_y_log10(breaks=c(25,100,400))+
  ggtitle("STAT1") +geom_text(hjust=1, vjust=0)
...
a <- ggplot(COMP, aes(x=Diagnosis, y= count)) + 
  geom_point(position=position_jitter(w=0.1,h=0)) + 
  scale_y_log10()+
  ggtitle("COMP") 
b <- ggplot(IL36RN, aes(x=Diagnosis, y= count)) + 
  geom_point(position=position_jitter(w=0.1,h=0)) + 
  scale_y_log10()+
  ggtitle("IL36RN")
c <- ggplot(IL36B, aes(x=Diagnosis, y= count)) + 
  geom_point(position=position_jitter(w=0.1,h=0)) + 
  scale_y_log10()+
  ggtitle("IL36B")
d <- ggplot(IL6, aes(x=Diagnosis, y= count)) + 
  geom_point(position=position_jitter(w=0.1,h=0)) + 
  scale_y_log10()+
  ggtitle("IL6")
e <-ggplot(SOCS3, aes(x=Diagnosis, y= count)) + 
  geom_point(position=position_jitter(w=0.1,h=0)) + 
  scale_y_log10()+
  ggtitle("SOCS3")
f <-ggplot(SOCS1, aes(x=Diagnosis, y= count)) + 
  geom_point(position=position_jitter(w=0.1,h=0)) + 
  scale_y_log10()+
  ggtitle("SOCS1")
g <-ggplot(TGFB1, aes(x=Diagnosis, y= count)) + 
  geom_point(position=position_jitter(w=0.1,h=0)) + 
  scale_y_log10()+
  ggtitle("TGFB1")
h <-ggplot(TNF, aes(x=Diagnosis, y= count)) + 
  geom_point(position=position_jitter(w=0.1,h=0)) + 
  scale_y_log10()+
  ggtitle("TNF")
i <-ggplot(ACVRL1, aes(x=Diagnosis, y= count)) + 
  geom_point(position=position_jitter(w=0.1,h=0)) + 
  scale_y_log10()+
  ggtitle("ACVRL1")
